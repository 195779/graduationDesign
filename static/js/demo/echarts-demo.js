$(function () {
        ...
        series : [
            {
                name:'出勤',
                type:'line',
                data:[450, 420, 467, 435, 411, 446, 436, 452, 426, 440, 461, 463],
                markPoint : {
                    data : [
                        {type : 'max', name: '最大值'},
                        {type : 'min', name: '最小值'}
            ...
            },
            {
                name:'缺勤',
                type:'line',
                data:[26, 59, 90, 64, 27, 47, 76, 22, 47, 64, 63, 23],
                markPoint : {
                    data : [
                       {type : 'max', name: '最大值'},
                        {type : 'min', name: '最小值'}
            ...
            },
            {
                name:'请假',
                type:'line',
                data:[36, 49, 20, 64, 27, 57, 46, 62, 37, 54, 53, 48],
                markPoint : {
                    data : [
                       {type : 'max', name: '最大值'},
                        {type : 'min', name: '最小值'}
            ...
            },
            {
                name:'出差',
                type:'line',
                data:[25, 29, 20, 24, 27, 37, 96, 42, 37, 24, 43, 13],
                markPoint : {
                    data : [
                       {type : 'max', name: '最大值'},
                        {type : 'min', name: '最小值'}
    ...
    var pieoption = {
        ...
        legend: {
            orient : 'vertical',
            x : 'left',
            data:['研发部','工程项目部','办公室','组装车间','市场销售部','财务处','人力资源处','后勤处']
        },
        calculable : true,
        series : [
            {
